...
You can also download a single file using :meth:`Beaker.dataset.stream_file() <services.DatasetClient.stream_file>`:

>>> contents = b"".join(beaker.dataset.stream_file(dataset, "conf.py", quiet=True))
<BLANKLINE>
